    ...
    <div class="container_SR">
      <div class="out_SR">
        <section style="display: block;">
          <div
            style="margin-top: 64px; margin-bottom: 56px; margin-left: 16px;"
          >
        ...
        <div class="outerbox_SR">
          <div class="out_SR">
            <div class="cards_SR">
              <div class=".card">
                <a
                  onclick="location.href='/account/myAccount/myInfo'"
                  class="aTag_SR"
                >
                  <div>
                  ...
                  <div class="contentInCard1_SR">
                    <div class="contentLetterInCard_SR">
                      개인정보 및 연락처를 알려주세요
                    </div>
                  </div>
                </a>
            ...
            <div class="cards_SR">
              <div class=".card">
                <a
                  onclick="location.href='/account/myAccount/loginAndSecurity'"
                  class="aTag_SR"
                >
                  <div>
                    <div style="margin-bottom: 16px;">
                ...
                <a href="#" class="aTag_SR">
                  <div>
                    <div style="margin-bottom: 16px;">
                      ...
                      >
                        <path
                          d="m19.8516 8.2051 3.542-1.275c.282-.102.429-.413.327-.697-.102-.282-.412-.426-.696-.327l-3.542 1.276c-.282.101-.429.413-.327.696.08.222.289.359.511.359.062 0 .123-.011.185-.032m3.7 3.981-3.291-.77c-.297-.071-.585.112-.653.405-.068.292.113.585.405.654l3.291.77c.042.01.083.015.124.015.247 0 .471-.169.529-.42.069-.292-.113-.585-.405-.654m-6.235-7.522c.164 0 .326-.074.432-.216l2.044-2.693c.182-.238.135-.58-.104-.761-.237-.182-.579-.137-.761.105l-2.044 2.693c-.181.238-.135.58.105.761.097.075.213.111.328.111m-11.777 8.173c.124.852-.371 1.675-1.181 1.967l-.963.346c-.258.093-.542-.04-.635-.298l-1.019-2.83c-.093-.257.041-.542.298-.634l5.648-2.036c.26-.093.547.041.641.301l.025.071c.083.23-.014.487-.229.606l-1.849 1.025c-.529.293-.822.883-.736 1.482"
                        ></path>
                        <path
                ...
                <a href="#" class="aTag_SR">
                  <div>
                    <div style="margin-bottom: 16px;">
                      ...
                      >
                        <path
                          d="m21.31 5.91a1.31 1.31 0 1 1 -1.31-1.31 1.31 1.31 0 0 1 1.31 1.31zm-8.31 9.69a1.31 1.31 0 1 0 1.31 1.31 1.31 1.31 0 0 0 -1.31-1.31zm-7-11a1.31 1.31 0 1 0 1.31 1.31 1.31 1.31 0 0 0 -1.31-1.31z"
                        ></path>
                        <path
