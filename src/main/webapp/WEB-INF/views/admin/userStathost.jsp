...
<div class="row">
  <div class="col-lg-3">
    <div class="panel panel-default">
      ...
      <div class="panel-heading"><c:out value="${user.userFstName }"/> 호스트님</div>
      <!-- /.panel-heading -->
    ...
    <div class="panel panel-default" >
      ...
      <div class="panel-heading">숙소정보</div>
      <!-- /.panel-heading -->
	      <div class="panel-body">
			<table class="table table-striped table-bordered table-hover">
					...
					<c:forEach items="${acms}" var="acms">
						<tr>
							<td>
								<a class='move' href='<c:out value="${acms.acmNum}"/>'>
									<c:out value="${acms.acmNum}" />_<c:out value="${acms.acmName}" />
								</a>
							</td>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(".move").on("click", function(e){
		    ...
		    e.preventDefault();
		    formObj.append("<input type='hidden' name='acmNum' value='"+$(this).attr("href")+"'>");
		
		    formObj.attr("action","/admin/adminviewAcm");
